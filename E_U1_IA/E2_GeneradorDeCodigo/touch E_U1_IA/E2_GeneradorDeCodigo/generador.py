def generador_funcion_java(nombre_funcion, parametros, tipo_retorno="void",
                           modificador_acceso="public static"):
    """
...
funciones = [
    ("calcularSuma", [("a", "int"), ("b", "int")], "int"),
    ("mostrarMensaje", [("mensaje", "String")]),
    ("esMayorDeEdad", [("edad", "int")], "boolean", "public"),
    ("mostrarMensaje", [("mensaje", "String")]),
    ("mostrarMensaje", [("mensaje", "String")]),
    ("mostrarMensaje", [("mensaje", "String")]),
...
for funcion in funciones:
    print(generador_funcion_java(*funcion))
    print() 
